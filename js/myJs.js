...
function textGenerate() {
    var n = "";
    var text = " Tại vì anh béo nhưng anh vẫn đẹp trai zl, yêu anh ";
...
$('#yes').click(function() {
    ...
    Swal.fire({
        ...
        cancelButtonText: "Thôi ngại lám :<<",
        ...
        if (result.value) {
            Swal.fire({
                ...
                background: '#fff url("../img/iput-bg.jpg")',
                title: 'Anh yêu em',
                text: "Anh sẽ dẫn em đi ăn lòng nè, nấu những món mà em thích, giờ thì inbox anh đi",
